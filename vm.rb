...
#    Updated: 2014/01/21 11:25:48 by glourdel         ###   ########.fr        #
#                                                                               #
# ***************************************************************************** #
...
class	Vm_filler
	attr_accessor :map, :player, :challenger, :interactif, :sid, :verbose, :time, :modif_time, :wait
	...
	def help
		puts "#{$0}, made by Hcao and Abanlin, version 1.1.1 Edit by Nalvin\n\n"
		...
		puts "   -w  --wait		wait a few seconds per round"
	end

	def version
		$stdout.write "# ------------- VM  version 1.1.1 ------------ #\n"
		$stdout.write "#                                              #\n"
		$stdout.write "# 42 / filler VM Developped by: Hcao - Abanlin #\n"
		$stdout.write "#                 Edit by Nalvin               #\n"
		$stdout.write "# -------------------------------------------- #\n"
	end
end
